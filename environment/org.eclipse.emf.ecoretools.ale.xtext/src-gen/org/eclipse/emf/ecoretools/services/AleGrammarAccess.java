...
public class AleGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		...
		//op=compOp right=expression | {And.left=current} 'and' right=expression | {Or.left=current} 'or' right=expression |
		...
		//'|' lambda=expression ')' | name=Ident '(' (params+=expression (',' params+=expression)*)? ')') | {Mult.left=current}
		//MultOp right=expression | {Add.left=current} addOp right=expression | {Comp.left=current} op=compOp right=expression |
